      ...
      <section className="relative overflow-hidden border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-white font-black mb-5" style={{ fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', lineHeight: 1.05 }}>
              Our Fleet
            </h1>
            <p className="text-gray-400 text-lg max-w-lg leading-relaxed">
              From economy transfers to VIP luxury — choose the vehicle that fits your journey.
            </p>
            <div className="flex justify-center md:justify-start gap-10 mt-12 flex-wrap">
              {[
          ...
          <div className="flex-1 w-full max-w-lg">
            <div className="bg-gradient-to-b from-transparent via-gray-900/50 to-gray-900 rounded-3xl border border-gray-800 overflow-hidden">
              <CarViewer3D type="luxury" />
            </div>
          </div>
        </div>
      </section>
